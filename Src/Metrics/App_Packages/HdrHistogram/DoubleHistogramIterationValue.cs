...
namespace HdrHistogram
{
    ...
    {
        private HistogramIterationValue integerHistogramIterationValue;
        ...
        internal DoubleHistogramIterationValue(HistogramIterationValue integerHistogramIterationValue)
        {
